...
golem::add_module(name = "analisis_whats", with_test = TRUE)
golem::add_module(name = "contenido_whats", with_test = TRUE) # Name of the module
...
## Vignette ----
usethis::use_vignette("whatsappListening")
